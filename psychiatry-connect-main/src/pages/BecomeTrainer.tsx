...
import { Mail, Lock, User, ArrowLeft, Loader2, GraduationCap, Calendar, CheckCircle2, Eye, EyeOff } from "lucide-react";
import { z } from "zod";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const { data: authData, error: signUpError } = await supabase.auth.signUp({
        ...
        options: {
          emailRedirectTo: "https://onlinecascpractice.com/trainer",
          data: {
