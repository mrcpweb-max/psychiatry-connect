...
import { Mail, Lock, User, ArrowLeft, Loader2, GraduationCap, Eye, EyeOff } from "lucide-react";
    ...
    try {
      if (mode === "signup") {
        const { error } = await supabase.auth.signUp({
          ...
          options: {
            emailRedirectTo: "https://onlinecascpractice.com/dashboard",
            data: {
        ...
        <Card className="w-full max-w-md animate-scale-in">
          <CardHeader className="text-center">
            <Link to="/" className="inline-flex items-center justify-center gap-2 mb-4">
              <img src={logo} alt="Online CASC Practice" className="h-10 w-auto" />
            </Link>
