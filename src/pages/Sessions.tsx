...
const sessionCategories = [
  {
    ...
    badge: "Best Value",
    options: [
      { name: "1 Station", price: 20, duration: "25 mins" },
      { name: "2 Stations", price: 35, duration: "35 mins" },
      { name: "3 Stations", price: 60, duration: "50 mins" },
    ],
    features: [
  ...
  },
  {
    ...
    options: [
      { name: "4 Stations Mock", price: 40, duration: "45-60 mins" },
      { name: "8 Stations Mock", price: 70, duration: "90-120 mins" },
    ],
    features: [
  ...
  },
  {
    ...
    hasGroupDropdown: true,
    groupOptions: {
      "2": [
        { name: "Group of 2 - 1 Station", price: 30, duration: "25 mins" },
        { name: "Group of 2 - 2 Stations", price: 60, duration: "50 mins" },
        { name: "Group of 2 - 3 Stations", price: 80, duration: "70 mins" },
      ],
      "3": [
        { name: "Group of 3 - 1 Station", price: 40, duration: "40 mins" },
        { name: "Group of 3 - 2 Stations", price: 60, duration: "60 mins" },
        { name: "Group of 3 - 3 Stations", price: 90, duration: "90 mins" },
      ],
    },
    features: [
      "Learn with peers",
...
export default function Sessions() {
  const [selectedGroupSize, setSelectedGroupSize] = useState<Record<string, string>>({
    group: "2",
  });
        ...
        <div className="container">
          <div className="space-y-12">
            {sessionCategories.map((category) => {
              const currentOptions = category.hasGroupDropdown
                ? category.groupOptions?.[selectedGroupSize[category.id] || "2"] || []
                : category.options || [];
              ...
              return (
                <Card key={category.id} className="overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    {/* Group size dropdown */}
                    {category.hasGroupDropdown && (
                      <div className="mb-6">
                        <label className="text-sm font-medium mb-2 block">Select Group Size</label>
                        <Select
                          value={selectedGroupSize[category.id] || "2"}
                          onValueChange={(value) =>
                            setSelectedGroupSize((prev) => ({ ...prev, [category.id]: value }))
                          }
                        >
